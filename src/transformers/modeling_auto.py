...
MODEL_FOR_TOKEN_MULTILABEL_CLASSIFICATION_MAPPING = OrderedDict(
    [
        # (DistilBertConfig, DistilBertForTokenMultiLabelClassification),
        ...
        # (ElectraConfig, ElectraForTokenMultiLabelClassification),
    ]
)
...
class AutoModelForTokenMultiLabelClassification:
    r"""
        :class:`~transformers.AutoModelForTokenMultiLabelClassification` is a generic model class
        that will be instantiated as one of the token classification model classes of the library
        when created with the `AutoModelForTokenMultiLabelClassification.from_pretrained(pretrained_model_name_or_path)`
        class method.
    ...
    def __init__(self):
        raise EnvironmentError(
            "AutoModelForTokenMultiLabelClassification is designed to be instantiated "
            "using the `AutoModelForTokenMultiLabelClassification.from_pretrained(pretrained_model_name_or_path)` or "
            "`AutoModelForTokenMultiLabelClassification.from_config(config)` methods."
        )
    ...
    def from_config(cls, config):
        ...
        Args:
            config (:class:`~transformers.PretrainedConfig`):
                ...
                - isInstance of `distilbert` configuration class: :class:`~transformers.DistilBertModelForTokenMultiLabelClassification` (DistilBERT model)
                - isInstance of `xlm` configuration class: :class:`~transformers.XLMForTokenMultiLabelClassification` (XLM model)
                - isInstance of `xlm roberta` configuration class: :class:`~transformers.XLMRobertaModelForTokenMultiLabelClassification` (XLMRoberta model)
                - isInstance of `bert` configuration class: :class:`~transformers.BertModelForTokenMultiLabelClassification` (Bert model)
                - isInstance of `albert` configuration class: :class:`~transformers.AlbertForTokenMultiLabelClassification` (AlBert model)
                - isInstance of `xlnet` configuration class: :class:`~transformers.XLNetModelForTokenMultiLabelClassification` (XLNet model)
                - isInstance of `camembert` configuration class: :class:`~transformers.CamembertModelForTokenMultiLabelClassification` (Camembert model)
                - isInstance of `roberta` configuration class: :class:`~transformers.RobertaModelForTokenMultiLabelClassification` (Roberta model)
                - isInstance of `electra` configuration class: :class:`~transformers.ElectraForTokenMultiLabelClassification` (Electra model)

        Examples::

            config = BertConfig.from_pretrained('bert-base-uncased')    # Download configuration from S3 and cache.
            model = AutoModelForTokenMultiLabelClassification.from_config(config)  # E.g. model was saved using `save_pretrained('./test/saved_model/')`
        """
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        in the `pretrained_model_name_or_path` string (in the following order):
            - contains `distilbert`: :class:`~transformers.DistilBertForTokenMultiLabelClassification` (DistilBERT model)
            - contains `xlm`: :class:`~transformers.XLMForTokenMultiLabelClassification` (XLM model)
            - contains `xlm-roberta`: :class:`~transformers.XLMRobertaForTokenMultiLabelClassification` (XLM-RoBERTa?Para model)
            - contains `camembert`: :class:`~transformers.CamembertForTokenMultiLabelClassification` (Camembert model)
            - contains `bert`: :class:`~transformers.BertForTokenMultiLabelClassification` (Bert model)
            - contains `xlnet`: :class:`~transformers.XLNetForTokenMultiLabelClassification` (XLNet model)
            - contains `roberta`: :class:`~transformers.RobertaForTokenMultiLabelClassification` (Roberta model)
            - contains `electra`: :class:`~transformers.ElectraForTokenMultiLabelClassification` (Electra model)
        ...
        Examples::
            ...
            model = AutoModelForTokenMultiLabelClassification.from_pretrained('bert-base-uncased')    # Download model and configuration from S3 and cache.
            model = AutoModelForTokenMultiLabelClassification.from_pretrained('./test/bert_model/')  # E.g. model was saved using `save_pretrained('./test/saved_model/')`
            assert model.config.output_attention == True
            # Loading from a TF checkpoint file instead of a PyTorch model (slower)
            config = AutoConfig.from_json_file('./tf_model/bert_tf_model_config.json')
            model = AutoModelForTokenMultiLabelClassification.from_pretrained('./tf_model/bert_tf_checkpoint.ckpt.index', from_tf=True, config=config)
